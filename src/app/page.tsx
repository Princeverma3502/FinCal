...
import { Copy, ShieldCheck, FileText, Settings2, LayoutDashboard, Table as TableIcon, Globe } from "lucide-react";
      ...
      <nav className="bg-white/80 backdrop-blur-md border-b border-slate-200 px-4 md:px-8 py-4 sticky top-0 z-[100]">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={() => setBaseline({ inputs, results })} className="hidden sm:flex items-center gap-2 text-xs font-bold bg-white border border-slate-200 px-4 py-2.5 rounded-xl hover:bg-indigo-50 transition-all active:scale-95">
