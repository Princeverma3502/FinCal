...
import { FileText, Settings2, LayoutDashboard, Table as TableIcon, Globe, PieChart as PieIcon } from "lucide-react";
...
export default function MortgageDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] antialiased pb-32 lg:pb-8 w-full max-w-[100vw] overflow-x-hidden">
      {/* Fixed Header */}
      <nav className="bg-white/80 backdrop-blur-md border-b border-slate-200 px-4 py-4 sticky top-0 z-[110] h-auto">
        <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center gap-y-3">
          ...
          <div className="flex items-center gap-2 flex-wrap justify-end relative z-[120]">
            <PrivacyToggle />
      ...
      <main className="relative max-w-7xl mx-auto p-4 md:p-8 overflow-x-hidden z-10">
        {/* Mobile Tabs */}
        <div className="lg:hidden flex bg-white p-1 rounded-2xl border border-slate-200 mb-6 sticky top-[80px] z-[100] shadow-sm w-full">
      ...
      <div className="lg:hidden fixed bottom-4 left-4 right-4 bg-slate-900/95 backdrop-blur-md text-white p-3 rounded-2xl shadow-2xl z-[150] flex justify-between items-center border border-white/10">
